var size = 0;
var placement = 'point';
function categories_ServiceTerritorycopy_1(feature, value, size, resolution, labelText,
...
default:
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(10,48,63,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}),fill: new ol.style.Fill({color: 'rgba(202,234,195,1.0)'}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
case 'NULL':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(10,48,63,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}),fill: new ol.style.Fill({color: 'rgba(247,252,245,1.0)'}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
var style_ServiceTerritorycopy_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_ServiceTerritorycopy_1(feature, value, size, resolution, labelText,
